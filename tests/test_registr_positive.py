...
class TestRegistration:
    ...
    result_email, status_email = RegistrationEmail().get_api_email()
    ...
    def test_get_registration_valid(self, browser):
        ...
        """Получаем код регистрации из письма"""
        ...
        """Если регистрация успешна- перезаписываем созданные пару email/пароль в файл settings"""
        page.driver.save_screenshot('reg_done.png')
